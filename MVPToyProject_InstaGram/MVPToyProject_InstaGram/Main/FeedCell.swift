...
class FeedCell : UITableViewCell {
    ...
    weak var heartDelegate : HeartBtnDelegate?
    weak var commentDelegate : CommentBtnDelegate?
    ...
    @IBAction func giveHeart(_ sender: Any) {
        ...
        if(!isClicked){
            ...
            self.heartDelegate?.clickHeartBtn(index, isClicked)
            isClicked = true
        } else {
    ...
    @IBAction func postComment(_ sender: Any) {
        self.commentDelegate?.clickCommentBtn(index)
    }
